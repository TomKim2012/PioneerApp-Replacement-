...
public class MyRequestBuilder{
	...
	public static String serverUrl= "http://"+serverAddress+"/PioneerServerMSSQL/index.php/api/flexipay_server/";
//	private static String serverUrl= "http://192.168.0.135/PioneerServer/index.php/api/flexipay_server/";
	...
	public static void setServerAddress(String serverAddress) {
		...
		serverUrl= "http://"+serverAddress+"/PioneerServerMSSQL/index.php/api/flexipay_server/";
	}
